...
func TestEnforcementPreflightChecksCapabilityThenClaudeThenCodex(t *testing.T) {
	...
	bridge := &enforcementReadinessBridge{
		...
		canary: bridgeprotocol.RelaySessionCanaryResponse{
			...
			MissingProfile: bridgeprotocol.RelaySessionCanaryMissing{Behavior: "default", ToolCount: 0}, InvalidProfileErrorCode: "profile_unknown", ConcurrentSessionCount: 2, UpstreamProcesses: []bridgeprotocol.RelaySessionCanaryProcess{},
		},
	}
